...
CDAC_TYPE_FIELD(CodeHeapListNode, /*pointer*/, BottomEndAddress, offsetof(HeapList, bottomEndAddress))
CDAC_TYPE_FIELD(CodeHeapListNode, /*pointer*/, TopStartAddress, offsetof(HeapList, topStartAddress))
