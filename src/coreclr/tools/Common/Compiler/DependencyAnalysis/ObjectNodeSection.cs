...
namespace ILCompiler.DependencyAnalysis
{
    ...
    public class ObjectNodeSection
    {
        ...
        public static readonly ObjectNodeSection ManagedColdCodeWindowsContentSection = new ObjectNodeSection(".managedcode$Z", SectionType.Executable);
        ...
        public static readonly ObjectNodeSection ManagedColdCodeUnixContentSection = new ObjectNodeSection("__managedcodecold", SectionType.Executable);
